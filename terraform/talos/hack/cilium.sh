...
HELM_RELEASE_FILE="$REPO_ROOT/kubernetes/infrastructure/controllers/cilium/helmrelease.yaml"
HELM_REPO_FILE="$REPO_ROOT/kubernetes/infrastructure/controllers/cilium/source.yaml"
...
NAMESPACE_FILE="$REPO_ROOT/kubernetes/infrastructure/controllers/cilium/namespace.yaml"
