...
HELM_RELEASE_FILE="$REPO_ROOT/kubernetes/infra/core/cilium/helmrelease.yaml"
HELM_REPO_FILE="$REPO_ROOT/kubernetes/infra/core/cilium/source.yaml"
...
NAMESPACE_FILE="$REPO_ROOT/kubernetes/infra/core/cilium/namespace.yaml"
